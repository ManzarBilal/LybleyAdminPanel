...
function BrandDashboard(props) {
    ...
    const spareParts =   data?.sparParts?.filter((item, i) => item?.userId === param?.id);
    const orders =   data?.orders?.filter((item, i) => item?.items?.find((it => it?.brandId === param?.id)));
    const transaction1 =   transaction?.filter(t1 => t1?.brandId === param?.id);
                ...
                <div className="container-xxl">
                            ...
                            <div className={`alert-danger alert mb-0`}>
                                <div className="d-flex align-items-center">
                                    ...
                                    <div className="flex-fill ms-3 text-truncate">
                                        ...
                                        <span className="small"> { brandByIdData?.totalPay}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className={`alert-danger alert mb-0`}>
                                <div className="d-flex align-items-center">
                                    ...
                                    <div className="flex-fill ms-3 text-truncate">
                                        ...
                                        <span className="small">{ brandByIdData?.totalDue}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div className="card">
                                                <div className="card-body py-xl-4 py-3 d-flex flex-wrap align-items-center justify-content-between">
                                                    <div className="left-info">
                                                        ...
                                                        <div><span className="fs-6 fw-bold me-2"> { orders1?.length}</span></div>
                                                    </div>
                    ...
                    <div className="row g-3 mb-3">
                        <div className="col-md-12">
                            <OrderList id={param?.id} url={props?.url} />
                        </div>
                    </div>
                    <div className="row g-3 mb-3">
                        <div className="col-md-12">
